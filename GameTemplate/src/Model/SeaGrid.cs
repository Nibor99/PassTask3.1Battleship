...
namespace BattleshipVB
{
    ...
    /// </summary>
        ...
        int ISeaGrid.Width => throw new NotImplementedException();

        int ISeaGrid.Height => throw new NotImplementedException();

        TileView ISeaGrid.Item => throw new NotImplementedException();
